...
public class NewDietScheduletActivity extends AppCompatActivity {
    ...
    /*Méthod to find previous registred diets for the event. The user can only create a event if they have at least one diet registred
     */
    ...
    /**Méthod created to discover if this activity is been used for create a new diet or updating
     * */
    ...
    /**Méthod to fill the fields of the page with the values from the event, so the user can update
     * */
    ...
    /**Méthod called when a diet is select in the spinner
     * */
    ...
    /**Méthod that interates in the array of diets found search for one diet with the id @dietId
     * */
    ...
    /**Méthod to show buttons for redirect the user to add diet activity
     * */
    ...
    /**Méthod to save the event created in Parse
     * */
    ...
    /**Méthod called when the user clicks in one of the buttons for days of week
     * */
    ...
    /**Méthod called when the user clicks in one of the edittext to set the time for the meal
     * */
    ...
    public static class TimePickerFragment extends android.app.DialogFragment
        ...
        /*Méthod called when the user selects a time in the timepicker
        */
    ...
    /**Méthod to create the notification of the event just created
     * */
