...
public class    NewExerciseActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks
    ...
    public void onConnectionSuspended(int cause) {
        ...
        Toast.makeText(this, "Cannot connect with Internet, please check your connection", Toast.LENGTH_LONG).show();
    }
